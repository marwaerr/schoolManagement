    ...
    * ********************************************************** */
    public function tattendance() {
        ...
        if ($_POST) {
            ...
            $teacher_type_filter = $this->input->post('teacher_type_filter');
            
            $salary_type = null;
            
            if (isset($salary_types[$teacher_type_filter])) {
                $salary_type = $salary_types[$teacher_type_filter];
            }
            ...
            $this->data['month'] = $month;
            $this->data['month_number'] = date('m', strtotime($this->data['month']));
            $this->data['salary_type'] = $salary_type;
            
            
            $this->data['teachers'] = $this->report->get_list('teachers', array('status' => 1, 'school_id'=>$school_id, $salary_type));
            $session = $this->report->get_single('academic_years', array('id' => $academic_year_id, 'school_id'=>$school_id, $salary_type));
            $this->data['school'] = $this->report->get_school_by_id($school_id);
